...
# SECRET_KEY = 'django-insecure-je++e!#r&%c_vjpb0hm67cpto(k=1!!ef*rsz-_uf)*q-4^ngc'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=60), # в реальном проекте лучше делать меньше, где-то 5 мин
